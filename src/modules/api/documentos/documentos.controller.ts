...
export class DocumentosController {
    ...
    async listarContratosBancoPublico(
        ...
        @Query('canal_venda') canal_venda?: 'MASTERCLASS' | 'EVENTOS' | 'TIME_VENDAS' | 'PALESTRANTES_EXTRAS',
        ...
        @Query('palestrante_id') palestrante_id?: string,
        @Query('palestrante_nome') palestrante_nome?: string,
    ...
    // Atualiza as observações da venda (texto do contrato + internas do sistema).
    ...
    atualizarObservacoesSistemaContrato(
        ...
        return this.documentosService.atualizarObservacoesSistemaContratoHistorico(
            id,
            body?.observacoes ?? '',
            body?.observacoes_contrato,
        );
    }
