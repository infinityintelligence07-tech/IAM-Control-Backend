...
export class QueryMigration1761501568992 implements MigrationInterface {
    name = 'QueryMigration1761501568992'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "usuarios" ADD "cpf" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."EFuncoes_old" AS ENUM('ADMINISTRADOR', 'ADVOGADO', 'COLABORADOR', 'DESENVOLVEDOR', 'DJ', 'ESTAGIARIO', 'LIDER', 'LIDER_DE_EVENTOS', 'PALESTRANTE', 'STAFF', 'VENDEDOR')`);
        await queryRunner.query(`ALTER TABLE "usuarios" ALTER COLUMN "funcao" DROP DEFAULT`);
