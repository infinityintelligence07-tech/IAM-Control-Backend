...
export class QueryMigration1761508017064 implements MigrationInterface {
    name = 'QueryMigration1761508017064'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."ESetores" RENAME TO "ESetores_old"`);
        await queryRunner.query(`CREATE TYPE "public"."ESetores" AS ENUM('ADMINISTRADOR', 'CD', 'COMERCIAL', 'CUIDADO_DE_ALUNOS', 'EVENTOS', 'EXPANSAO', 'EXPANSAO_NEGOCIOS', 'FINANCEIRO', 'GH', 'JURIDICO', 'MARKETING', 'TECNOLOGIA')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."ESetores_old" AS ENUM('ADMINISTRADOR', 'CD', 'COMERCIAL', 'CUIDADO_DE_ALUNOS', 'EVENTOS', 'EXPANSAO', 'FINANCEIRO', 'GH', 'JURIDICO', 'MARKETING', 'TECNOLOGIA')`);
        await queryRunner.query(`ALTER TABLE "usuarios" ALTER COLUMN "setor" DROP DEFAULT`);
