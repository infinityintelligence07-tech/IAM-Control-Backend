...
export class QueryMigration1761508311714 implements MigrationInterface {
    name = 'QueryMigration1761508311714'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."ESetores" RENAME TO "ESetores_old"`);
        await queryRunner.query(`CREATE TYPE "public"."ESetores" AS ENUM('ADMINISTRADOR', 'CD', 'COMERCIAL', 'CUIDADO_DE_ALUNOS', 'EVENTOS', 'EXPANSAO', 'EXPANSAO_NEGOCIOS', 'FINANCEIRO', 'GH', 'IAM_STORE', 'JURIDICO', 'MARKETING', 'P7', 'TECNOLOGIA')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."ESetores_old" AS ENUM('ADMINISTRADOR', 'CD', 'COMERCIAL', 'CUIDADO_DE_ALUNOS', 'EVENTOS', 'EXPANSAO', 'EXPANSAO_NEGOCIOS', 'FINANCEIRO', 'GH', 'JURIDICO', 'MARKETING', 'P7', 'TECNOLOGIA')`);
        await queryRunner.query(`ALTER TABLE "usuarios" ALTER COLUMN "setor" DROP DEFAULT`);
