...
export class QueryMigration1768163181018 implements MigrationInterface {
    name = 'QueryMigration1768163181018';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "endereco_eventos" ("criado_em" TIMESTAMP NOT NULL DEFAULT now(), "atualizado_em" TIMESTAMP NOT NULL DEFAULT now(), "deletado_em" TIMESTAMP, "criado_por" integer, "atualizado_por" integer, "id" SERIAL NOT NULL, "id_polo" integer NOT NULL, "local_evento" character varying, "logradouro" character varying, "numero" character varying, "bairro" character varying, "cidade" character varying, "estado" character varying, "cep" character varying, CONSTRAINT "pk_endereco_eventos" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(`CREATE TYPE "public"."EStatusTurmas" AS ENUM('AGUARDANDO_LIBERACAO', 'ENCERRADA', 'INSCRICOES_ABERTAS', 'INSCRICOES_PAUSADAS')`);
        await queryRunner.query(
            `CREATE TABLE "turmas" ("criado_em" TIMESTAMP NOT NULL DEFAULT now(), "atualizado_em" TIMESTAMP NOT NULL DEFAULT now(), "deletado_em" TIMESTAMP, "criado_por" integer, "atualizado_por" integer, "id" SERIAL NOT NULL, "id_polo" integer NOT NULL, "id_treinamento" integer NOT NULL, "lider_evento" integer, "edicao_turma" character varying, "cep" character varying NOT NULL, "logradouro" character varying NOT NULL, "complemento" character varying, "numero" character varying NOT NULL, "bairro" character varying NOT NULL, "cidade" character varying, "estado" character varying, "id_endereco_evento" integer, "status_turma" "public"."EStatusTurmas" NOT NULL DEFAULT 'AGUARDANDO_LIBERACAO', "autorizar_bonus" boolean NOT NULL DEFAULT false, "id_turma_bonus" integer, "capacidade_turma" integer NOT NULL, "meta" integer, "data_inicio" date NOT NULL, "data_final" date NOT NULL, "turma_aberta" boolean NOT NULL DEFAULT false, "detalhamento_bonus" jsonb, CONSTRAINT "pk_turmas" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ESetores" AS ENUM('ADMINISTRADOR', 'CD', 'COMERCIAL', 'CUIDADO_DE_ALUNOS', 'EVENTOS', 'EXPANSAO', 'EXPANSAO_NEGOCIOS', 'FINANCEIRO', 'GH', 'IAM_STORE', 'JURIDICO', 'MANUTENCAO', 'MARKETING', 'P7', 'TECNOLOGIA')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."EFuncoes" AS ENUM('ADMINISTRADOR', 'ADVOGADO', 'CLIPADOR', 'COLABORADOR', 'COPYWRITER', 'DESENVOLVEDOR', 'DESIGNER_GRAFICO', 'DJ', 'EDICAO_DE_VIDEO', 'ESTAGIARIO', 'FOTOGRAFO', 'INSIDE_SALES', 'LIDER', 'LIDER_DE_CONFRONTO', 'LIDER_DE_MASTERCLASS', 'LIDER_DE_EVENTOS', 'LOGISTICA', 'PALESTRANTE', 'RELACIONAMENTO_COM_CLIENTES', 'SOCIAL_MEDIA', 'SOCIAL_SELLING', 'STAFF', 'TRAFEGO_DIGITAL', 'TUTOR_MISSAO', 'VENDEDOR', 'WEB_DESIGNER')`,
        );
        await queryRunner.query(
            `CREATE TABLE "usuarios" ("criado_em" TIMESTAMP NOT NULL DEFAULT now(), "atualizado_em" TIMESTAMP NOT NULL DEFAULT now(), "deletado_em" TIMESTAMP, "criado_por" integer, "atualizado_por" integer, "id" SERIAL NOT NULL, "nome" character varying NOT NULL, "primeiro_nome" character varying NOT NULL, "sobrenome" character varying NOT NULL, "cpf" character varying, "cnpj" character varying, "chave_pix" character varying, "rg" character varying, "pis" character varying, "ctps" character varying, "email" character varying NOT NULL, "senha" character varying NOT NULL, "setor" "public"."ESetores" NOT NULL DEFAULT 'CUIDADO_DE_ALUNOS', "funcao" "public"."EFuncoes" array NOT NULL DEFAULT '{COLABORADOR}', "telefone" character varying NOT NULL, "url_foto" character varying, "provider" character varying DEFAULT 'credentials', "cep" character varying, "logradouro" character varying, "complemento" character varying, "numero" character varying, "bairro" character varying, "cidade" character varying, "estado" character varying, "tipo_colaborador" character varying, "data_nascimento" TIMESTAMP, "data_admissao" TIMESTAMP, "data_demissao" TIMESTAMP, CONSTRAINT "UQ_446adfc18b35418aac32ae0b7b5" UNIQUE ("email"), CONSTRAINT "pk_usuarios" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "masterclass_pre_cadastros" ADD CONSTRAINT "FK_2b53401465f54dfcf5c468952b1" FOREIGN KEY ("id_turma") REFERENCES "turmas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "masterclass_pre_cadastros" ADD CONSTRAINT "FK_1280c15003c95878b8479d9f288" FOREIGN KEY ("id_aluno_vinculado") REFERENCES "alunos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "alunos" ADD CONSTRAINT "FK_2f04d4ddb0a4d639b2f22597f24" FOREIGN KEY ("id_aluno_vinculado") REFERENCES "alunos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "endereco_eventos" ADD CONSTRAINT "FK_62dcc74ace6ea48c387fabb0388" FOREIGN KEY ("id_polo") REFERENCES "polos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "turmas" ADD CONSTRAINT "FK_10af650d5a41dca39c724f65830" FOREIGN KEY ("id_endereco_evento") REFERENCES "endereco_eventos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
