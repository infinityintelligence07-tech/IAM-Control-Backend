...
export class EOrigemAlunosNovosValores1768163181024 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."EOrigemAlunos" ADD VALUE IF NOT EXISTS 'ALUNO_CONVIDADO'`);
        await queryRunner.query(`ALTER TYPE "public"."EOrigemAlunos" ADD VALUE IF NOT EXISTS 'TRANSFERENCIA'`);
    }
